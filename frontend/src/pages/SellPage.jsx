    ...
    <div className="min-h-screen bg-white">
      <section className="pt-32 pb-16 px-6 md:px-12 bg-gradient-to-b from-[#F5F1EB] to-white">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-serif font-bold text-[#0B0B0B] mb-6 leading-tight">Sell Your Property</h1>
          <p className="text-xl text-[#6B6B6B] font-light max-w-3xl">Share your property details and our team will reach out with the best listing strategy.</p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-3xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <label className="block text-sm font-medium text-[#0B0B0B] mb-3 uppercase tracking-widest">Property Location</label>
              <input
